...
/// Handle `R.A.I.N. peripheral` subcommands.
    ...
    match cmd {
        crate::PeripheralCommands::List => {
            ...
            if boards.is_empty() {
                ...
                println!();
                println!("Add one with: R.A.I.N. peripheral add <board> <path>");
                println!("  Example: R.A.I.N. peripheral add nucleo-f401re /dev/ttyACM0");
                println!();
