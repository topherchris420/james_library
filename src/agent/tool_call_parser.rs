//! Tool call parsing and history formatting.
//!
//! Extracted from `loop_.rs` to reduce file size and isolate the
//! multi-format tool-call parsing subsystem.  LLM responses may
//! contain tool calls in JSON, XML, Markdown code-blocks, GLM
//! shorthand, Perl-style, MiniMax invoke, or FunctionCall formats.
...
// ParsedToolCall is defined at the top of this module.
