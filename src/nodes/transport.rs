...
/// - `X-R.A.I.N.-Timestamp` — unix epoch seconds
/// - `X-R.A.I.N.-Nonce` — random UUID v4
/// - `X-R.A.I.N.-Signature` — HMAC-SHA256 hex digest
///
...
impl NodeTransport {
    ...
    pub async fn send(
        ...
        let resp = self
            .http
            .post(&url)
            .header("X-R.A.I.N.-Timestamp", timestamp.to_string())
            .header("X-R.A.I.N.-Nonce", &nonce)
            .header("X-R.A.I.N.-Signature", &signature)
