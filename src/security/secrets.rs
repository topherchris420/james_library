...
// in `~/.R.A.I.N./.secret_key` with restrictive file permissions (0600). The
...
pub struct SecretStore {
    /// Path to the key file (`~/.R.A.I.N./.secret_key`)
    key_path: PathBuf,
...
impl SecretStore {
    ...
    pub fn new(R.A.I.N._dir: &Path, enabled: bool) -> Self {
        Self {
            key_path: R.A.I.N._dir.join(".secret_key"),
            enabled,
        }
    }
