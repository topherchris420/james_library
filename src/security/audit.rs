...
impl AuditLogger {
    ...
    pub fn new(config: AuditConfig, R.A.I.N._dir: PathBuf) -> Result<Self> {
        let log_path = R.A.I.N._dir.join(&config.log_path);
...
mod tests {
    ...
    fn audit_event_with_actor() {
        ...
        assert_eq!(actor.username, Some("@R.A.I.N._user".to_string()));
    }
