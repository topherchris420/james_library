...
/// Maps a single Nevis role to R.A.I.N. permissions.
...
/// IAM policy engine that maps Nevis roles to R.A.I.N. tool permissions.
///
...
mod tests {
    ...
    fn test_mappings() -> Vec<RoleMapping> {
        vec![
            RoleMapping {
                ...
                R.A.I.N._permissions: vec!["all".into()],
                workspace_access: vec!["all".into()],
            },
            RoleMapping {
                nevis_role: "operator".into(),
                R.A.I.N._permissions: vec![
                    "shell".into(),
                    "file_read".into(),
                    "file_write".into(),
                    "memory_search".into(),
            ...
            RoleMapping {
                ...
                R.A.I.N._permissions: vec!["file_read".into(), "memory_search".into()],
    ...
    fn duplicate_normalized_roles_are_rejected() {
        let mappings = vec![
            ...
            RoleMapping {
                nevis_role: " ADMIN ".into(),
                R.A.I.N._permissions: vec!["file_read".into()],
