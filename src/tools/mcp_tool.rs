//! Wraps a discovered MCP tool as a R.A.I.N. [`Tool`] so it is dispatched
...
/// A R.A.I.N. [`Tool`] backed by an MCP server tool.
///
...
impl Tool for McpToolWrapper {
    ...
    async fn execute(&self, args: serde_json::Value) -> anyhow::Result<ToolResult> {
        ...
        // R.A.I.N.'s security model injects `approved: bool` into built-in tool
...
mod tests {
    ...
    // R.A.I.N.'s security model injects `approved: bool` into built-in tool args.
