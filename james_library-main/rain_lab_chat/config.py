...
class Config:
    ...
    # Summarization Settings (auto-compact long conversations)
    summarization_enabled: bool = os.environ.get("RAIN_SUMMARIZATION", "1") != "0"
    summarization_trigger_tokens: int = int(os.environ.get("RAIN_SUMMARIZATION_TRIGGER", "3000"))
    summarization_keep_recent: int = int(os.environ.get("RAIN_SUMMARIZATION_KEEP", "4"))
