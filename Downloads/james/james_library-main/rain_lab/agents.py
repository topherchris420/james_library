"""Agent dataclass and factory for the R.A.I.N. Lab research team."""
...
from .config import meeting_response_length_guidance, no_self_name_intro_guidance
