...
//! verification) in isolation. The gateway module (`rain_labs::gateway`) exposes
...
use rain_labs::gateway::verify_whatsapp_signature;
...
fn gateway_body_limit_is_reasonable() {
    assert_eq!(
        rain_labs::gateway::MAX_BODY_SIZE,
        65_536,
...
fn gateway_timeout_is_reasonable() {
    assert_eq!(
        rain_labs::gateway::REQUEST_TIMEOUT_SECS,
        30,
...
fn gateway_rate_limit_window_is_60s() {
    assert_eq!(
        rain_labs::gateway::RATE_LIMIT_WINDOW_SECS,
        60,
