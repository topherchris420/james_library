...
use rain_labs::providers::compatible::AuthStyle;
use rain_labs::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use rain_labs::providers::compatible::OpenAiCompatibleProvider;
