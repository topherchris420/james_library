...
Complete guide to setting up a R.A.I.N.-powered robot on Raspberry Pi 5.
...
mkdir -p ~/.R.A.I.N./models
cp models/ggml-base.bin ~/.R.A.I.N./models/
```
...
mkdir -p ~/.R.A.I.N./models/piper
cd ~/.R.A.I.N./models/piper
wget https://huggingface.co/rhasspy/piper-voices/resolve/main/en/en_US/lessac/medium/en_US-lessac-medium.onnx
wget https://huggingface.co/rhasspy/piper-voices/resolve/main/en/en_US/lessac/medium/en_US-lessac-medium.onnx.json

# Test
echo "Hello, I am your robot!" | piper --model ~/.R.A.I.N./models/piper/en_US-lessac-medium.onnx --output_file test.wav
aplay test.wav
```
...
### 7. Build R.A.I.N. Robot Kit

```bash
# Clone repo (or copy from USB)
git clone https://github.com/R.A.I.N.-labs/R.A.I.N.
cd R.A.I.N.

# Build robot kit
cargo build --release -p R.A.I.N.-robot-kit

# Build main R.A.I.N. (optional, if using as agent)
cargo build --release
```
...
```bash
mkdir -p ~/.R.A.I.N.
nano ~/.R.A.I.N./robot.toml
```

```toml
# ~/.R.A.I.N./robot.toml - Real Hardware Configuration
...
# Test speaker
echo "Testing speaker" | piper --model ~/.R.A.I.N./models/piper/en_US-lessac-medium.onnx --output_file - | aplay -D plughw:0,0
...
FIFO_PATH = "/tmp/R.A.I.N._sensors.fifo"
...
```bash
# Configure R.A.I.N. to use robot tools
cat > ~/.R.A.I.N./config.toml << 'EOF'
...
cp ~/R.A.I.N./crates/robot-kit/SOUL.md ~/.R.A.I.N./workspace/

# Start agent
./target/release/R.A.I.N. agent
```
...
# Start sensor loop
if [ ! -p /tmp/R.A.I.N._sensors.fifo ]; then
    mkfifo /tmp/R.A.I.N._sensors.fifo
fi
...
```bash
# /etc/systemd/system/R.A.I.N.-robot.service
sudo tee /etc/systemd/system/R.A.I.N.-robot.service << 'EOF'
[Unit]
Description=R.A.I.N. Robot
After=network.target ollama.service

[Service]
Type=simple
User=pi
WorkingDirectory=/home/pi/R.A.I.N.
...
sudo systemctl enable R.A.I.N.-robot
sudo systemctl start R.A.I.N.-robot

# Check status
sudo systemctl status R.A.I.N.-robot
journalctl -u R.A.I.N.-robot -f  # View logs
```
