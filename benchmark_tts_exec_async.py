...
async def main():
    if os.name != 'nt':
        ...
        async def patched_edge_speak(self, text, voice, rate="+0%", volume="+0%"):
            ...
            # Using asyncio.create_subprocess_exec to avoid blocking the event loop
            await asyncio.create_subprocess_exec("./dummy_afplay")
    ...
    print(f"Optimized Implementation (Async Subprocess)")
