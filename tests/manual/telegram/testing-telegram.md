...
This guide covers testing the Telegram channel integration for R.A.I.N..
...
6. **Error logging**
    ...
    ```bash
    RUST_LOG=debug R.A.I.N. channel start
    ```
...
Solution: Check user allowlist
  ...
  4. Run: R.A.I.N. onboard --channels-only
```
...
| ---------------------- | ---------- | -------------------------------- |
| Health check time      | <5s        | `time R.A.I.N. channel doctor`   |
| First response time    | <3s        | Time from sending to receiving   |
| Message split overhead | <50ms      | Check logs for timing            |
| Memory usage           | <10MB      | `ps aux \| grep R.A.I.N.`        |
| Binary size            | ~3-4MB     | `ls -lh target/release/R.A.I.N.` |
...
```bash
# Maximum logging
RUST_LOG=trace R.A.I.N. channel start
...
# Validate config
cat ~/.R.A.I.N./config.toml | grep -A 3 "\[channels_config.telegram\]"
```
...
- [R.A.I.N. Main README](../../README.md)
- [Contributing Guide](../../CONTRIBUTING.md)
- [Issue Tracker](https://github.com/R.A.I.N.-labs/R.A.I.N./issues)
