...
//! verification) in isolation. The gateway module (`R.A.I.N.::gateway`) exposes
...
use R.A.I.N.::gateway::verify_whatsapp_signature;
...
fn gateway_timeout_is_reasonable() {
    assert_eq!(
        R.A.I.N.::gateway::REQUEST_TIMEOUT_SECS,
        30,
...
fn gateway_rate_limit_window_is_60s() {
    assert_eq!(
        R.A.I.N.::gateway::RATE_LIMIT_WINDOW_SECS,
        60,
