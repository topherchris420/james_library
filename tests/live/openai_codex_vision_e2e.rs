...
use anyhow::Result;
use R.A.I.N.::providers::{ChatMessage, ChatRequest, ProviderRuntimeOptions};
...
async fn openai_codex_second_vision_support() -> Result<()> {
    ...
    let provider = R.A.I.N.::providers::create_provider_with_options("openai-codex", None, &opts)?;
