...
use R.A.I.N.::providers::compatible::AuthStyle;
use R.A.I.N.::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use R.A.I.N.::providers::compatible::OpenAiCompatibleProvider;
