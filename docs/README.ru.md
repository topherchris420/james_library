...
Русскоязычная точка входа в task-oriented документацию.

## Языковые хабы

- EN: [`docs/README.md`](README.md)
- 中文: [`docs/README.zh-CN.md`](README.zh-CN.md)
- 日本語: [`docs/README.ja.md`](README.ja.md)
- Русский: [`docs/README.ru.md`](README.ru.md)
- Français: [`docs/README.fr.md`](README.fr.md)
- Tiếng Việt: [`docs/i18n/vi/README.md`](i18n/vi/README.md)

## Быстрые разделы

- Единое оглавление: [`docs/SUMMARY.md`](SUMMARY.md)
...
- Типизированное суждение: [`docs/typed-judgment.md`](typed-judgment.md)
- R.A.I.N. Rig (необязательный локальный узел): [`docs/rig/README.md`](rig/README.md)
...
- Contributing: [`docs/contributing/README.md`](contributing/README.md)
