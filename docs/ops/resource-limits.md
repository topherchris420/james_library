...
## Problem
R.A.I.N. has rate limiting (20 actions/hour) but no resource caps. A runaway agent could:
...
Automatically create a cgroup for R.A.I.N. with limits.
