...
| 二进制大小 | ~3-4MB | `ls -lh target/release/R.A.I.N.` |
| 健康检查 | <5s | `time R.A.I.N. channel doctor` |
| 首次响应 | <3s | Telegram 中手动测试 |
| 消息拆分 | <50ms | 检查调试日志 |
| 内存使用 | <10MB | `ps aux \| grep R.A.I.N.` |
...
- Issue：<https://github.com/R.A.I.N.-labs/R.A.I.N./issues>
