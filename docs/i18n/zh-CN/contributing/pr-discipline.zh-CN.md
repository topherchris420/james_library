...
- 如果不可避免需要类似身份的上下文，仅使用 R.A.I.N. 范围的角色/标签（例如 `R.A.I.N.Agent`、`R.A.I.N.Operator`、`R.A.I.N._user`）。
- 推荐的身份安全命名调色板：
    - 参与者标签：`R.A.I.N.Agent`、`R.A.I.N.Operator`、`R.A.I.N.Maintainer`、`R.A.I.N._user`
    - 服务/运行时标签：`R.A.I.N._bot`、`R.A.I.N._service`、`R.A.I.N._runtime`、`R.A.I.N._node`
    - 环境标签：`R.A.I.N._project`、`R.A.I.N._workspace`、`R.A.I.N._channel`
