...
R.A.I.N. supports custom API endpoints for both OpenAI-compatible and Anthropic-compatible providers.
...
# or: export R.A.I.N._API_KEY="your-api-key"
R.A.I.N. agent
```

## llama.cpp Server (Recommended Local Setup)

R.A.I.N. includes a first-class local provider for `llama-server`:
...
```bash
R.A.I.N. models refresh --provider llamacpp
R.A.I.N. agent -m "hello"
```

You do not need to export `R.A.I.N._API_KEY=dummy` for this flow.

## SGLang Server

R.A.I.N. includes a first-class local provider for [SGLang](https://github.com/sgl-project/sglang):
...
```bash
R.A.I.N. models refresh --provider sglang
R.A.I.N. agent -m "hello"
```
...
R.A.I.N. includes a first-class local provider for [vLLM](https://docs.vllm.ai/):
...
```bash
R.A.I.N. models refresh --provider vllm
R.A.I.N. agent -m "hello"
```
