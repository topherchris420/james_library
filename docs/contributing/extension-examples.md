...
R.A.I.N.'s architecture is trait-driven and modular.
...
```rust
// In your crate: use R.A.I.N.::tools::traits::{Tool, ToolResult};
...
```rust
// In your crate: use R.A.I.N.::channels::traits::{Channel, ChannelMessage, SendMessage};
...
Providers are LLM backend adapters. Each provider connects R.A.I.N. to a different model API.
...
```rust
// In your crate: use R.A.I.N.::providers::traits::Provider;
...
```rust
// In your crate: use R.A.I.N.::memory::traits::{Memory, MemoryEntry, MemoryCategory};
