# R.A.I.N. PR Workflow (High-Volume Collaboration)

This document defines how R.A.I.N. handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to R.A.I.N./project-native labels.
...
- Confirm any required identity-like wording uses R.A.I.N./project-native terminology.
