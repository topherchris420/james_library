...
Rules for pull request quality, attribution, privacy, and handoff in R.A.I.N..
...
- If identity-like context is unavoidable, use R.A.I.N.-scoped roles/labels only (e.g., `R.A.I.N.Agent`, `R.A.I.N.Operator`, `R.A.I.N._user`).
