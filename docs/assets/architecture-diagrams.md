# R.A.I.N. Architecture Diagrams

This document provides visual representations of R.A.I.N.'s architecture, execution modes, and data flows.

---

## 1. Execution Modes

**Ways R.A.I.N. can be run:**

```mermaid
flowchart TD
    Start[R.A.I.N. CLI] --> Onboard[onboard<br/>Setup wizard]
...
```mermaid
flowchart TB
    Start[[R.A.I.N. daemon]] --> SpawnComponents
...
```mermaid
flowchart TB
    Client[HTTP Client] --> Gateway[R.A.I.N. Gateway]
...
flowchart TB
    ...
    Defaults --> EnvOverrides[apply_env_overrides<br/>R.A.I.N._* env vars]
...
*Generated for R.A.I.N. v0.1.0 - Architecture Documentation*
