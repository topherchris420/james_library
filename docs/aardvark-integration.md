...
The rest of R.A.I.N. speaks a single language: `ZcCommand` → `ZcResponse`.
...
DatasheetTool.call(args)
  ...
  → "download": fetch PDF from args["url"] → save to ~/.R.A.I.N./hardware/datasheets/
...
```
 SDK FILES          aardvark-sys            R.A.I.N. core
 (vendor/)          (crates/)               (src/)
─────────────────────────────────────────────────────────────────
