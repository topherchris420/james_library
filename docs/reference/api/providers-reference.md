...
3. Generic fallback env vars: `R.A.I.N._API_KEY` then `API_KEY`
...
- After multimodal normalization, R.A.I.N. sends image payloads through Ollama's native `messages[].images` field.
- If a non-vision provider is selected, R.A.I.N. returns a structured capability error instead of silently ignoring images.
...
- R.A.I.N. normalizes a trailing `/api` in `api_url` automatically.
...
- Model discovery: `R.A.I.N. models refresh --provider sglang`
...
- Model discovery: `R.A.I.N. models refresh --provider vllm`
...
- Model discovery: `R.A.I.N. models refresh --provider osaurus`
...
- Model discovery: `R.A.I.N. models refresh --provider nvidia`
