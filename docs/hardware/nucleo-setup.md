# R.A.I.N. on Nucleo-F401RE — Step-by-Step Guide

Run R.A.I.N. on your Mac or Linux host. Connect a Nucleo-F401RE via USB. Control GPIO (LED, pins) via Telegram or CLI.

---

## Get Board Info via Telegram (No Firmware Needed)

R.A.I.N. can read chip info from the Nucleo over USB **without flashing any firmware**. Message your Telegram bot:
...
R.A.I.N. includes everything for Nucleo-F401RE:
...
| Flash command | `R.A.I.N. peripheral flash-nucleo` | Builds firmware, flashes via probe-rs |
...
### 1.2 Flash via R.A.I.N.

From the R.A.I.N. repo root:
...
| 5 | `R.A.I.N. daemon` or `R.A.I.N. agent -m "Turn on LED"` |
...
- **GPIO commands ignored** — Check `path` in config matches your serial port. Run `R.A.I.N. peripheral list` to verify.
