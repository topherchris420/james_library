...
This guide covers native Nextcloud Talk integration for R.A.I.N..
...
Add this section in `~/.R.A.I.N./config.toml`:
...
R.A.I.N. daemon
# or
R.A.I.N. gateway --host 127.0.0.1 --port 3000
```
...
When `webhook_secret` is configured, R.A.I.N. verifies:
...
- R.A.I.N. ignores bot-originated webhook events (`actorType = bots`).
- R.A.I.N. ignores non-message/system events.
...
3. Confirm R.A.I.N. receives and replies in the same room.
