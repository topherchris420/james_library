...
[INFO] ✓ Audit logging enabled (~/.config/R.A.I.N./audit.log)
...
$ R.A.I.N. security --status
Security Status:
  ✓ Sandbox: Landlock (Linux kernel 6.2)
  ✓ Memory monitoring: 512MB limit
  ✓ Audit logging: ~/.config/R.A.I.N./audit.log
  → 47 events logged today

# Tắt sandbox tường minh (ghi vào config)
$ R.A.I.N. config set security.sandbox.enabled false

# Bật backend cụ thể
$ R.A.I.N. config set security.sandbox.backend firejail

# Điều chỉnh giới hạn
$ R.A.I.N. config set security.resources.max_memory_mb 2048
```
...
✅ **Hiển thị trạng thái** — `R.A.I.N. security --status`
