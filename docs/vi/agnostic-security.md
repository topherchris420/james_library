...
|---------|-----------|--------------|--------|
| **R.A.I.N. cơ bản** | 3.4MB | <5MB | ✅ Hiện tại |
...
| Phần cứng | RAM | R.A.I.N. (cơ bản) | R.A.I.N. (full security) | Trạng thái |
|----------|-----|-----------------|--------------------------|--------|
...
**Ngay cả với full security, R.A.I.N. chỉ dùng <5% RAM trên board $10.**

---

## 5. Tính hoán đổi: mọi thứ vẫn pluggable

### Cam kết chính của R.A.I.N.: hoán đổi bất kỳ thứ gì
