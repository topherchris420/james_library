# Tài liệu tham khảo Providers — R.A.I.N.
...
3. Biến môi trường dự phòng chung: `R.A.I.N._API_KEY`, sau đó là `API_KEY`
...
- Sau khi chuẩn hóa multimodal, R.A.I.N. gửi payload hình ảnh qua trường `messages[].images` gốc của Ollama.
- Nếu chọn provider không hỗ trợ vision, R.A.I.N. trả về lỗi rõ ràng thay vì âm thầm bỏ qua hình ảnh.
...
- Khám phá model: `R.A.I.N. models refresh --provider nvidia`
