# Thêm Board và Tool — Hướng dẫn phần cứng R.A.I.N.

Hướng dẫn này giải thích cách thêm board phần cứng mới và tool tùy chỉnh vào R.A.I.N..

## Bắt đầu nhanh: Thêm board qua CLI

```bash
# Thêm board (cập nhật ~/.R.A.I.N./config.toml)
R.A.I.N. peripheral add nucleo-f401re /dev/ttyACM0
R.A.I.N. peripheral add arduino-uno /dev/cu.usbmodem12345
R.A.I.N. peripheral add rpi-gpio native   # cho Raspberry Pi GPIO (Linux)
...
Với feature `rag-pdf`, R.A.I.N. có thể lập chỉ mục file PDF:
...
2. **Thêm vào config** — `R.A.I.N. peripheral add my-board /dev/ttyUSB0`
...
| Lệnh | Mô tả |
|------|-------|
| `R.A.I.N. peripheral list` | Liệt kê các board đã cấu hình |
| `R.A.I.N. peripheral add <board> <path>` | Thêm board (ghi vào config) |
| `R.A.I.N. peripheral flash` | Nạp firmware Arduino |
| `R.A.I.N. peripheral flash-nucleo` | Nạp firmware Nucleo |
| `R.A.I.N. hardware discover` | Liệt kê thiết bị USB |
| `R.A.I.N. hardware info` | Thông tin chip qua probe-rs |
