...
class OpenAIClient(BaseLM):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Respect request timeouts passed via backend_kwargs.
        self._timeout = timeout if timeout is not None else kwargs.get("timeout")
        ...
        self.async_client = openai.AsyncOpenAI(api_key=api_key, base_url=base_url, timeout=self._timeout)
