"""
Tests for R.A.I.N.-tools package.
"""
...
def test_import_tool_decorator():
    ...
    from R.A.I.N._tools import tool
...
def test_cli_allows_interactive_without_message():
    ...
    from R.A.I.N._tools.__main__ import parse_args
...
async def test_invoke_in_event_loop_raises():
    ...
    from R.A.I.N._tools import create_agent, shell
...
async def test_shell_tool():
    ...
    from R.A.I.N._tools import shell
...
async def test_file_tools(tmp_path):
    ...
    from R.A.I.N._tools import file_read, file_write
