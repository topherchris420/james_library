//! Example: Implementing a custom Memory backend for R.A.I.N.
//!
...
// ── Re-define the trait types (in your app, import from R.A.I.N.::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 R.A.I.N. Memory Demo — InMemoryBackend\n");
